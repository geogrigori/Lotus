      ...
      <FooterWrap>
        ...
        <SocialMedia>
          <SocialMediaWrap>
            ...
            <WebsiteRights>Lotus © {new Date().getFullYear()} All rights reserved.</WebsiteRights>
            <SocialIcons>
              <SocialIconLink href='/' target='_blank' arial-label='Facebook'>
                <FaFacebook />
              </SocialIconLink>
              <SocialIconLink href='//www.instagram.com/geozidev/' target='_blank' arial-label='Instagram'>
                <FaInstagram/>
              </SocialIconLink>
              ...
              <SocialIconLink href='//www.linkedin.com/in/geogrigori/' target='_blank' arial-label='Linkedin'>
                <FaLinkedin />
              </SocialIconLink>
            </SocialIcons>
          </SocialMediaWrap>
